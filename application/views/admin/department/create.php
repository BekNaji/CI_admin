          ...
          <div class="">
            ...
            <div class="row">
             ...
             <div class="x_panel">
                  ...
                  <a href="<?= $url ?>admin/department/index"><button class="btn btn-success"><?= $this->lang->line('department') ?></button></a>
                  <div class="x_content">
                     <?= @$alert; ?>

                      <form method="post" action="<?= $url ?>admin/department/store" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
