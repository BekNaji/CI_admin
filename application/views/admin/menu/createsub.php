        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
             ...
             <div class="x_panel">
                  <div class="x_title">
                    <h2><?= $this->lang->line('create') ?> <?= $this->lang->line('submenu') ?></h2>
                  ...
                  <div class="x_content">
                     <?= @$alert; ?>
                      ...
                      <form method="post" action="<?= $url ?>admin/menu/storesub" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
