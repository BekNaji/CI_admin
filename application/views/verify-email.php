		...
		<div class="container">
			<div class="row">
				<div class="module module-login span4 offset4">
					...
					action="<?php echo base_url('login/verifyEmail') ?>">
						...
						<div class="module-body">
							...
							<div class="control-group">
								<div class="controls row-fluid">
									<span class="text-error"><?php echo form_error("verify_email"); ?></span>
									<input value="<?php echo set_value('verify_email'); ?>" name="email_code" class="span12" type="text" placeholder="Code">
								</div>
							</div>
